...
PACK(typedef struct t_FrSkyData {
  FrSkyChannelData channels[MAX_FRSKY_A_CHANNELS];
#ifdef FRSKY_SPORT_A3_A4
  uint8_t usrProto:4; // Protocol in FrSky user data, 0=None, 1=FrSky hub, 2=WS HowHigh, 3=Halcyon
  uint8_t blades:4;   // How many blades for RPMs, 0=2 blades
  uint8_t screensType:4;
  uint8_t voltsSource:4;
#else
