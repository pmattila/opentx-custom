...
#define ALARM_LEVEL(channel, alarm)       ((g_model.frsky.channels[channel].alarms_level >> (2*alarm)) & 3)
...
#if defined(FRSKY_SPORT)
  #define TELEMETRY_STREAMING()           (frskyStreaming > 0 && frskyData.rssi[0].value > 0)
  ...
  #define TELEMETRY_GPS_SPEED_FORMAT      "%d.%03d,"
  #define TELEMETRY_GPS_SPEED_ARGS        frskyData.hub.gpsSpeed_bp, frskyData.hub.gpsSpeed_ap,
...
void frskyUpdateCells(void);
  ...
  #define MODEL_TELEMETRY_PROTOCOL() ((g_model.protocol == PROTO_PXX) ? PROTOCOL_FRSKY_SPORT : PROTOCOL_FRSKY_D)
#endif
